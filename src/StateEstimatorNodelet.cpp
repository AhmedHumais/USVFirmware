...
#include "StateEstimatorNodelet.h"
...
namespace HEAR
{
    ...
    void StateEstimatorNodelet::onInit(){
        ...
        auto to_rot = new Quat2Rot(0);
        auto to_eul = new Rot2Eul(0);
        ...
        sys->createPub(TYPE::QUAT, "/navio/quaternion", imu_navio->getOutputPort<tf2::Quaternion>(Navio2Imu::OP::QUAT));
        ...
        sys->createPub(TYPE::Float3, "/imu/ori", to_eul->getOutputPort<Vector3D<float>>(Rot2Eul::OP::EUL_ANGLES));
